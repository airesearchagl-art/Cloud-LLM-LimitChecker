...
def _report_to_dict(report: GitHubActionsBillingReport) -> dict:
    return {
        ...
        "discounted_standard_minutes": report.discounted_standard_minutes,
        "billable_standard_minutes": report.billable_standard_minutes,
    ...
    def snapshot(self, *, now: datetime | None = None, cooldown_seconds: int = DEFAULT_COOLDOWN_SECONDS) -> dict:
        with self._lock:
            ...
            return {
                ...
                "discounted_standard_minutes": None,
                "billable_standard_minutes": None,
